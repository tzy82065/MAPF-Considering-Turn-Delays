...
def main():
    ...
    for test_number in range(1, 101):
        ...
        sx, sy, gx, gy = generate_points(size_x=161, size_y=61, ox=ox, oy=oy, num_points=6, min_distance=1)
        # sx, sy, gx, gy = generate_points(size_x=13, size_y=7, ox=ox, oy=oy, num_points=2, min_distance=1)
        # ox, oy = read_map_file('C:/Users/10721/PycharmProjects/pythonProject/Bachelorarbeit/map/random-32-32-10.map')
        # 网格大小
        grid_size = 1.0
        # 智能体半径
    ...
    df.to_excel(f'{6}_2 .xlsx', index=False)
    print(f"----------k={6}结果写入完成----------")
